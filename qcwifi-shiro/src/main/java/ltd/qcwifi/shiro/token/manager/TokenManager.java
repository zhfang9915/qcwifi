package ltd.qcwifi.shiro.token.manager;
...
import ltd.qcwifi.shiro.token.SampleRealm;
import ltd.qcwifi.shiro.token.ShiroToken;
...
public class TokenManager {
	...
	public static String getNickname(){
		return getToken().getNickname()==null?getUserName():getToken().getNickname();
	}
	/**
	 * 获取当前用户NAME
	 * @return
