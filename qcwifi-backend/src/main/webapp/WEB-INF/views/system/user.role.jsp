...
<body>
	<div class="container-fluid">
		<h3>当前会员账号 ： <small>${user.username }</small></h3>
		<hr/>
		<div class="row">
			<div class="col-md-2"></div>
			<div class="col-md-3">
				<table id="table_existRole" class="grid-table"></table>
			</div>
			<div class="col-md-2 text-center">
				<button type="button" class="btn btn-default btn-lg" 
					style="margin-top: 170px;"
					onclick="ur.uncorrelationRole('${user.id}');">
					<span class="glyphicon glyphicon-forward"></span>
				</button>
				<hr/>
				<button type="button" class="btn btn-default btn-lg" 
					style="margin-top: 10px;"
					onclick="ur.correlationRole('${user.id}');">
					<span class="glyphicon glyphicon-backward"></span>
				</button>
			</div>
			<div class="col-md-3">
				<table id="table_optionalRole" class="grid-table"></table>
			</div>
			<div class="col-md-2"></div>
		</div>
	...
	<script rootURL=${qc.rootPath } src="${qc.nginx }static/script/system/user.role.js"></script>
	<script type="text/javascript">
		$(function() {
			ur.existRoleInit('${user.id}');
			ur.optionalRoleInit('${user.id}');
