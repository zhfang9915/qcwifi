...
<link rel="stylesheet" href="${qc.nginx }css/login/login.css">
...
<!-- 						<li data-target="#carousel-example-generic" data-slide-to="2"></li> -->
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="${qc.nginx }img/login/banner.jpg" alt="...">
...
<!-- 						</div> -->
	...
	<script rootPath="${qc.nginx }" type="text/javascript" src="${qc.nginx }script/common.js"></script>
