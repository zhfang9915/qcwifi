                ...
                <div class="in-single">
                	<form class="layui-form layui-single-form" action="">
                        ...
                        <div class="layui-form-item">
                          ...
                          <div class="layui-input-block">
                            <input type="text" name="emailCode" lay-verify="required|number" placeholder="请输入您邮箱接收到的验证码" autocomplete="off" class="layui-input">
                        ...
                        <div class="layui-form-item layui-form-button">
                          <div class="layui-input-block">
                            <button class="layui-btn layui-lg-btn" lay-submit lay-filter="bindingEmail">确认绑定</button>
                          </div>
                        </div>
                      </form>
                </div>
...
<script rootURL=${qc.rootPath } src="${qc.nginx }script/cloud/personal/settings.binding.email.js"></script>
</body>
</html>
