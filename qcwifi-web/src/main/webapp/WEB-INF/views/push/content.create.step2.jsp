						...
						<div class="layui-label-select">
								...
								<div class="layui-item-floor T10001">
									<div class="layui-item-titleline">
										<div class="layui-input-inline">
											<input lay-filter="area" type="radio" name="contentTemp" value="T10001" title="登陆中海报" checked>
										</div>
										<span class="miaoshu">WIFI连接中呈现的全屏海报推广内容</span>
										<i class="layui-icon btn-close">&#xe61a;</i>
									</div>
									<div class="layui-item-boxcont">
										<div class="left-cont">
											<div class="layui-form-item">
												<label class="layui-form-label">海报内容</label>
												<div class="layui-input-block">
													<p class="h-cont h-active" data-val="3">3*5"</p>
													<p class="h-cont" data-val="1">1*5"</p>
											...
											<div class="layui-form-item">
												...
												<div class="layui-input-block">
													...
													<div id="imgarea_more" style="display: inline;">
														<div class="imgarea">
															<i class="layui-icon">&#xe654;</i>
															<p>添加图片</p>
															<img src="" style="display: none;">
							...
							<c:if test="${!empty T10002 && T10002.state=='Y'}">
								...
								<div class="layui-item-floor T10002">
									<div class="layui-item-titleline">
										<div class="layui-input-inline">
											<input type="radio" lay-filter="area" name="contentTemp" value="T10002" title="成功页推广">
										</div>
										<span class="miaoshu">WIFI连接成功后跳转的页面地址</span>
										<i class="layui-icon btn-close">&#xe619;</i>
									</div>
									<div class="layui-item-boxcont" style="display: none">
										<div class="layui-form-item">
											<label class="layui-form-label">链接地址</label>
											<div class="layui-input-block">
												<input type="text" name="T10002_url" placeholder="配置此链接后，在WIFI连接成功后跳转此地址" autocomplete="off" class="layui-input" style="width: 80%;">
											</div>
										</div>
									</div>
								</div>
							...
							<c:if test="${!empty T10003 && T10003.state=='Y'}">
								...
								<div class="layui-item-floor T10003">
									<div class="layui-item-titleline">
										<div class="layui-input-inline">
											<input type="radio" lay-filter="area" name="contentTemp" value="T10003" title="底部推广条">
										</div>
...
<script rootURL=${qc.rootPath } staticURL=${qc.nginx } src="${qc.nginx }script/cloud/push/content.create.step2.js"></script>
</body>
